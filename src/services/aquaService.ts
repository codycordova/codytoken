...
export class AquaService {
  ...
  // Token contract IDs (you'll need to add the actual CODY token contract ID)
  private static readonly TOKEN_CONTRACTS = {
    CODY: process.env.CODY_TOKEN_CONTRACT || 'GAW55YAX46HLIDRONLOLUWP672HTFXW5WWTEI2T7OXVEFEDE5UKQDJAK', // Replace with actual contract ID
    USDC: process.env.USDC_TOKEN_CONTRACT || 'GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN',
    AQUA: process.env.AQUA_TOKEN_CONTRACT || 'AQUA' // Replace with actual contract ID
  };
